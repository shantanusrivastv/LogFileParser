...
namespace LogFileParser.Core.Tests
{
    ...
    public class LogParserTest
    {
        ...
        [Test]
        public void Should_Throw_Exception_While_Parsing_If_LogFields_Count_Does_Not_Match_With_W3C_File_Fields()
        {
            //Arrange
        ...
        [Test]
        public void Should_Throw_Exception_While_Executing_TryParse_If_LogFields_Count_Does_Not_Match_With_W3C_File_Fields()
        {
            //Arrange
            var logFields = MockW3CMisMatchFields().Split();

            //Act
            void TestDelegate() => _sut.TryParse<W3CLogFormat>(logFields);
